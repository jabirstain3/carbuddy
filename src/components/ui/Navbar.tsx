        ...
        <div className="w-full navbar mx-auto px-0">
            ...
            <div className="navbar-end">
                ...
                <details className="dropdown dropdown-end">
                    <summary tabIndex={0} role="button" className="btn btn-ghost lg:hidden p-3 bg-base dark:bg-based border rounded-full border-based dark:border-base hover:bg-scnd dark:hover:bg-scnd">
                        <svg

...
const Navbar = () => {
    const manu = <>
        ...
        <li><a className="hover:bg-scnd hover:text-based active:text-scnd" href="/" >About Us</a></li>
    ...
    return (
        <div className="border w-full navbar mx-auto px-0">
            ...
            <div className="navbar-center hidden md:flex">
                <ul className="menu menu-horizontal px-1 text-based dark:text-base font-medium text-lg">
                    {manu}
                </ul>
            </div>
            <div className="navbar-end">
                <ul className="menu menu-horizontal gap-2 items-center text-based dark:text-base font-medium text-lg">
                    <li className="hidden md:inline border rounded-lg"><a className="hover:bg-scnd">Log In</a></li>
                    <li ><ThemeProvider/></li>
                </ul>
                <details className="dropdown dropdown-end">
                    <summary tabIndex={0} role="button" className="btn btn-ghost md:hidden p-3 bg-base dark:bg-based border rounded-full border-based dark:border-base hover:bg-scnd dark:hover:bg-scnd">
                        <svg
